    ...
    return (
      <footer className="py-4 px-6 text-center text-dark-500 text-sm">
        <div className="flex flex-wrap items-center justify-center gap-4">
          ...
          <span>•</span>
          <Link href="/cookies" className="hover:text-dark-300 transition-colors">
            쿠키 정책
          </Link>
        </div>
        <p className="mt-2 text-dark-600">
          © {currentYear} 마케터 생존기. All rights reserved.
        </p>
      </footer>
    );
  }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <h3 className="text-xl font-bold text-white mb-4">마케터 생존기</h3>
            <p className="text-dark-400 text-sm">
              실제 마케팅을 배우는 시뮬레이션 게임. 클라이언트를 수주하고,
              전략을 세우고, 성과를 만들어내세요!
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="mailto:support@marketer-survival.com"
                  className="text-dark-400 hover:text-white transition-colors text-sm"
                >
                  support@marketer-survival.com
                </a>
              </li>
              <li>
                <Link
        ...
        <div className="mt-12 pt-8 border-t border-dark-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-sm">
            ...
            <span className="text-dark-500">대한민국</span>
          </div>
        </div>
      </div>
    </footer>
